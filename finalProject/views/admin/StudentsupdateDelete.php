...
<head>
    ...
    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/studentsUD.css">
...
<html>
    <h2 style="color: #B8C6CC;">Update/Delete Students :-</h2>
    <center>
...
<?php
        ...
        $sql = "select * from users where users = 'student' and status = 'verified' or status = 'blocked'";
...
?>
        ...
        <table border="1" class="student-table">
            <tr>
                ...
                <a href="studentsUpdate.php?username=<?=$userArray['username']?>">Update</a> |
                <a href="studentsDelete.php?username=<?=$userArray['username']?>">Delete</a> </td>
            </tr>
