...
<head>
    ...
    <title>Verify/Block Teachers</title>

    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/teachersUD.css">
...
<html>
    <h2 style="color: #B8C6CC;">Update/Delete Teachers :-</h2>
    <center>
...
<?php
        ...
        $sql = "select * from users where users = 'teacher' and status = 'verified' or status = 'blocked'";
...
?>
        ...
        <table border="1" class="teacher-table">
            <tr>
                ...
                <td style="width: 180px; "><?=$userArray['email']?></td>
                ...
                <td style="width: 80px; "><?=$userArray['status']?></td>
                <td class="action" style="width: 120px;">
                <a href="teachersUpdate.php?username=<?=$userArray['username']?>">Update</a> |
                <a href="teachersDelete.php?username=<?=$userArray['username']?>">Delete</a> </td>
            </tr>
