...
<head>
    ...
    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/adminStudentsList.css">
...
<body>
    ...
    <center>
    <h1 style="color: #B8C6CC;">Students List</h1>
    ...
    <div class="student-search">
        ...
        <center>
            ...
            <fieldset>
                ...
                <input type="text" placeholder="Enter Username" name="username" onkeyup="showStudent(this.value)">
