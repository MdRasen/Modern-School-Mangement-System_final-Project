...
<head>
    ...
    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/adminTeachersAction.css">
...
<html>
    <h2 style="color: #B8C6CC;">Verify/Block Teachers :-</h2>
    <center>
...
<?php
        ...
        $sql = "select * from users where users = 'teacher' and status = 'unverified' or status = 'blocked'";
...
?>
        ...
        <table border="1" class="teacher-table">
            <tr>
                ...
                <td class="action" style="width: 120px;"><a href="TeachersverifyBlock.php?username=<?=$userArray['username']?>">Verify/Block</a></td>
            </tr>
