...
<head>
    ...
    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/adminTeachersList.css">
...
<body>
    ...
    <center>
    <h1 style="color: #B8C6CC;">Teachers List</h1>
    ...
    <div class="teacher-search">
        ...
        <center>
            ...
            <fieldset>
                ...
                <input type="text" placeholder="Enter Username" name="username" onkeyup="showTeacher(this.value)">
