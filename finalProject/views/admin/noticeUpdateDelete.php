...
<head>
    ...
    <!-- External CSS Link -->
    <link rel="stylesheet" href="../../assets/css/noticeUD.css">
...
<html>
    <h2 style="color: #B8C6CC;">Update/Delete Notices :-</h2>
    <center>
        ...
        <table border="1" class="notice-table">
            <tr>
                ...
                <td class="action" style="width: 120px;">
                    <a href="../admin/noticeUpdate.php?notice_id=<?=$noticeArray['notice_id']?>">Update</a> | 
                    <a href="../admin/noticeDelete.php?notice_id=<?=$noticeArray['notice_id']?>">Delete</a>
                </td>
            </tr>
